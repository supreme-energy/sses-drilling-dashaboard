...
export default function WellboreMediumCurve({ className, transparent, openHole }) {
  ...
  const getColors = defaultColor => (transparent ? transparentColor : openHole ? openHoleColor : defaultColor);
    ...
    >
      ...
      <g id="Scratch-Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Illustration-/-Wellbore_Medium_Grey_Curve" transform="translate(4.000000, 2.000000)">
          <path
            d="M70.9999938,37.0017359 L70.8370971,82.8370971 L71,82.9833617 L71,97 C71,102.522847 75.4771525,
            107 81,107 L131,107 C131.170849,107 131.340698,
            106.995715 131.509444,106.987248 L140.998264,106.999998 C140.999421,107.166529 141,107.333197 141,
            107.5 C141,146.436075 109.436075,178 70.5,178 C31.5639251,
            178 0,146.436075 0,107.5 C0,68.5639251 31.5639251,37 70.5,37 C70.6668005,37 70.8334658,
            37.0005793 70.9999938,37.0017359 Z"
            id="Combined-Shape"
